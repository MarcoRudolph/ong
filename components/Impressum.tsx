...
const Impressum: React.FC<ImpressumProps> = ({ isVisible, onClose }) => {
  if (!isVisible) return null;

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative bg-white w-full max-w-3xl mx-4 p-6 rounded-lg shadow-lg overflow-y-auto">
        {/* Close Button */}
        <button
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <h2 className="text-2xl font-bold mb-4">Impressum</h2>
            ...
            <p>Mantra Thai Massage</p>
            <p>Alfred Deville</p>
            <p>Gauchstrasse 17 - Unterlindenpassage</p>
            <p>79098 Freiburg</p>

            <p className="mt-4 mb-2">Kontakt:</p>
            <p>Telefon: 0761 61 25 81 45</p>
            <p>Email: info@mantra-freiburg.de</p>

            <p className="mt-4 mb-2">Umsatzsteuer:</p>
